...
| FILE_GET_SIZE                   |     RegX(1), RegX(2)      |                                              Met la taille du fichier en octet dnas RegX(1) ; descripteur dans RegX(2)                                              |
| FILE_RESET_CURSOR               |          RegX(1)          |                                                  Déplace le curseur de lecture au début ; descripteur dans RegX(1)                                                  |
| FILE_SEEK_CURSOR                |     RegX(1), RegX(2)      |                                                 Déplace le curseur de lecture a RegX(1) ; descripteur dans RegX(2)                                                  |
...
| FILE_READ_DOUBLEWORD            |     RegX(1), RegX(2)      |                                      Lit un mot (uint32) dans le fichier et le stocke dans RegX(1) ; descripteur dans RegX(2)                                       |
...
| FILE_APPEND_DOUBLEWORD          |     RegX(1), RegX(2)      |                                            Ajoute un mot (uint32) à la fin du fichier RegX(1) ; descripteur dans RegX(2)                                            |
...
| FILE_IS_DOUBLEWORD_REMAINING    |     RegX(1), RegX(2)      |                                Retourne s'il reste des mots (uint32) à lire dans le fichier dans RegX(1) ; descripteur dans RegX(2)                                 |
